    ...
    <section className="pricing container section">
      ...
      <div className="pricing__container grid">
        <div className="pricing__item">
          ...
          <p className="pricing__title">Lorem ipsum 
            dolor sit amet consectetur adipisicing elit. Doloribus, animi?
          </p>
        ...
        <div className="pricing__item best">
          ...
          <p className="pricing__title">Lorem ipsum dolor sit amet consectetur 
            adipisicing elit. Qui, animi!</p>
        ...
        <div className="pricing__item">
          ...
          <p className="pricing__title">Lorem ipsum dolor sit amet consectetur
             adipisicing elit. Mollitia, eligendi!</p>
